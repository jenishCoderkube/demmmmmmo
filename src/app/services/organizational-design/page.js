...
const SLUG = "organizational-design";
const PAGE_TYPE = "ORGANIZATIONAL_DESIGN";
...
export async function generateMetadata() {
  ...
  return {
    title: `${service?.title || "Organizational Design"} | Guided Solutions`,
    description:
      service?.description || "Expert search for MedTech leadership.",
  };
}

export default async function OrganizationalDesignPage() {
