...
const jobfunction = ({ theme = "light" }) => {
  ...
  const heroData = {
    ...
    description: (
      <>
        Our expertise is organized deliberately to help you navigate complex
        challenges. Each path below represents focused specialization, allowing
        you to identify the perspective most relevant to your specific context.
        {/* Two buttons in one row, placed immediately after description */}
        <div className="gs__services-btn-row">
      ...
      <TermsHero
        ...
        imageDiv={
          <div className="gs__article-img">
            <Image src={Blogimg} alt="article-img" width={800} height={450} />
          </div>
        }
      />
