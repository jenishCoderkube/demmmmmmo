...
function Alsovisit({ theme = "dark", items = [] }) {
    ...
    >
      <div className="gs__container">
        <div className="gs__also-visit-container">
          <h2 className="gs__h2-title">You can also visit</h2>
        </div>
              ...
              <div className="gs__also-visit-actions">
                <button className="gs__btn">
                  <span className="gs__btn-inner">
                    <span className="gs__btn-text">{item.btn1 || "Our Approach"}</span>
                    <span className="gs__btn-text">{item.btn2 || "Case Studies"}</span>
                  </span>
                </button>
